...
if (id) {
  // edit mode
  title = "แก้ไขแบนเนอร์";
  bannersStore.getById(id);
  ({ banner } = storeToRefs(bannersStore));
}
...
async function onSubmit(values) {
  try {
    ...
    console.log(values.bannerFileName);
    ...
    <div class="card bg-base-200 mt-5">
      <div class="card-body">
          ...
          <Form
            ...
            :initial-values="banner"
            v-slot="{ errors, isSubmitting }"
          >

            <div class="mb-2">
                <label class="mb-2" :class="{ 'is-invalid': errors.bannerFromFile }">รูปภาพหน้าปก <span class="required">*</span></label>
            </div>
            <div class="flex flex-col justify-center items-center mb-5">
              ...
              <input
                ...
                />
                <div class="invalid-feedback mt-2 text-left w-full">{{ errors.bannerFromFile }}</div>
            </div>
