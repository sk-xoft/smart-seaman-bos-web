...
if (certid) {
  // edit mode
  title = "แก้ไขประกาศนียบัตร";
  
  certificatesStore.getCotById(certid, id);
...
async function onSubmit(values) {
  try {
    ...
    if(certificatesStore.get_res_code === 'WA00000'){
      message = "แก้ไขประกาศนียบัตรเสร็จสิ้น";
      ...
      message = '"' + certificatesStore.get_res_desc + '"' + " การแก้ไขประกาศนียบัตรเกิดข้อผิดพลาด กรุณาลองใหม่อีกครั้ง";
      await router.push(`/certificates/view/${id}`);
      alertStore.error(message);
    }
...
<template>
  ...
  <BreadcrumbView link_menu="/certificates" name_menu="จัดการข้อมูลประกาศนียบัตร" :view_menu="`/certificates/view/${id}`" name_view_menu="ข้อมูลผู้ใช้" title="แก้ไขประกาศนียบัตร" />
    ...
    <div class="card bg-base-200 mt-5">
      <div class="card-body">
        ...
        <div class="form-row grid grid-cols-1 gap-5">
            ...
            <div class="form-group flex flex-col">
                <label class="mb-2">อัพโหลดไฟล์ประกาศนียบัตร</label>
